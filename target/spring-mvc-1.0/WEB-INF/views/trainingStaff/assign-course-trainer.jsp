...
<c:url var="assignTrainerURL" value="/training-staff/trainer/assign-course"/>
<c:url var="assignCourseAPI" value="/api/trainer/assign"/>
<c:url var="deleteCourseAPI" value="/api/trainer/assign"/>
<script src="//cdn.jsdelivr.net/npm/sweetalert2@10"></script>
<html>
<head>
    <title>Assign courses for trainer</title>
</head>
<body>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form:form class="form-horizontal" role="form" id="formSubmit"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right"
                                   for="name">Trainer name:</label>
                            <div class="col-sm-9">
                                <form:input path="name" cssClass="col-xs-10 col-sm-5"/>
                            </div>
                            <form:hidden path="id" id="trainerId" value="${model.id}"/>
                        </div>
                    </form:form>
                            ...
                            <div class="pull-right tableTools-container">
                                <div class="dt-buttons btn-overlap btn-group">
                                    <button id="btnDelete" type="button" onclick="warningBeforeDelete()"
                                            ...
                                            data-toggle="tooltip" title='Hủy gán khóa học cho trainer'>
															<span>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <c:forEach var="item" items="${trainerCourseList.listResult}">
                            <tr>
                                <!-- value = id cua bai viet  -->
                                <!-- nó lặp, nên cần phân biệt id checkbox nào của bài viết nào do đó, dùng checkbox+id của bài viết -->
                                    <%--                                    <td><input type="checkbox" id="checkbox_${item.id}" value="${item.id}" ></td>--%>
...
<script>
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        // get id trainer từ arr gan cho trainerId
        var trainerId = new Array(arr[1]);
        // gop 2 mang lai
        var data2 = trainerId.concat(ids);
        console.log(data2)
    ...
    function warningBeforeDelete() {
        swal({
            ...
            if (isConfirm) {
                ...
                // put mang ids vao
                deleteTrainerCourse(ids);
            }
        });
    }

    function deleteTrainerCourse(data) {
        $.ajax({
            url: '${deleteCourseAPI}',
            type: 'DELETE',
